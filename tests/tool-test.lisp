      ...
      (unwind-protect
           (progn
             ...
             (tool:tool-execute (make-instance 'tool:line-edit-tool)
                                nil
                                `((:file-path . ,temp-file)
                                  (:operations ((:operation . "add") (:start-line . 1) (:end-line . 1) (:content . "new-line")))))
      ...
      (unwind-protect
           (progn
             ...
             (tool:tool-execute (make-instance 'tool:line-edit-tool)
                                nil
                                `((:file-path . ,temp-file)
                                  (:operations ((:operation . "remove") (:start-line . 1) (:end-line . 1)))))
             (ok (string= expected (alexandria:read-file-into-string temp-file))))
        (ignore-errors (delete-file temp-file))))))
      ...
      (unwind-protect
           (progn
             ...
             (tool:tool-execute (make-instance 'tool:line-edit-tool)
                                nil
                                `((:file-path . ,temp-file)
                                  (:operations ((:operation . "replace") (:start-line . 1) (:end-line . 1) (:content . "replaced")))))
             (ok (string= expected (alexandria:read-file-into-string temp-file))))
        (ignore-errors (delete-file temp-file))))))
           ...
           (progn
             ...
             (ok (signals
                     (tool:tool-execute (make-instance 'tool:line-edit-tool)
                                        nil
                                        `((:file-path . ,temp-file)
                                          (:operations ((:operation . "add") (:start-line . 0) (:end-line . 0) (:content . "new-line")))))
                     'error)))
        (ignore-errors (delete-file temp-file))))))
           ...
           (progn
             ...
             (ok (signals
                     (tool:tool-execute (make-instance 'tool:line-edit-tool)
                                        nil
                                        '((:file-path . temp-file)
                                          (:operations ((:operation . "invalid") (:start-line . 1)))))
                     'error)))
        (ignore-errors (delete-file temp-file))))))
